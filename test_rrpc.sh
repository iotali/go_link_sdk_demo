...
curl -X POST "https://deviot.know-act.com/api/v1/device/rrpc" \
  ...
  -d "{
    ...
    \"productKey\": \"QLTMkOfW\",
    \"requestBase64Byte\": \"$(echo -n '{\"id\":\"123\",\"version\":\"1.0\",\"method\":\"LightSwitch\",\"params\":{\"switch\":1}}' | base64 -w 0)\",
    \"timeout\": 5000
    }"
...
curl -X POST "https://deviot.know-act.com/api/v1/device/rrpc" \
  ...
  -d "{
    \"deviceName\": \"WjJjXbP0X1\",
    \"productKey\": \"QLTMkOfW\",
    \"requestBase64Byte\": \"$(echo -n '{\"id\":\"456\",\"version\":\"1.0\",\"method\":\"GetStatus\",\"params\":{}}' | base64 -w 0)\",
    \"timeout\": 5000
    }"
